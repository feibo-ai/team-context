用途：4 种角色类型、6 条分配规则，以及 plan 文档 "How to split" 段的输出模板。
...
- Decisions recorded in the team decision log even if seniors disagree.
- Retrospective MUST NOT use "I told you so."

## Anti-patterns
- ❌ No DRI (most common AI Native failure)
